...
#     _name = 'dsl.physiotherapist'
#     _description = 'Physiotherapist'
...
class DSLPhysiotherapist(models.Model):
    _name = 'dsl.physiotherapist'
    _description = 'Speechtherapist'

    name = fields.Char(required=True, tracking=True)
    code = fields.Char(string='Speechtherapist ID', readonly=True, copy=False)
    ...
    def create(self, vals):
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('dsl.physiotherapist') or '/'
        return super(DSLPhysiotherapist, self).create(vals)
